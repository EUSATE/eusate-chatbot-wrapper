(function () {
    ...
    class ChatbotUI {
        constructor() {
            ...
            this.closeChatFrame = () => {
                ...
                (_a = this.chatIframe.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage({ isChatOpen: false }, '*');
            };
            this.toggleChatFrame = () => {
                var _a;
                if (this.chatIframe.style.transform === 'scale(1)') {
                    ...
                    (_a = this.chatIframe.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage({ isChatOpen: true }, '*');
                }
            };
    ...
    console.log('Initiating CHATBOT UI');
    new ChatbotUI();
